...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_cam_on'
        db.add_column(u'main_userprofile', 'is_cam_on',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.is_mic_on'
        db.add_column(u'main_userprofile', 'is_mic_on',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_cam_on'
        db.delete_column(u'main_userprofile', 'is_cam_on')

        # Deleting field 'UserProfile.is_mic_on'
        db.delete_column(u'main_userprofile', 'is_mic_on')
