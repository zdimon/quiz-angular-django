...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.account'
        db.add_column(u'main_userprofile', 'account',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.account'
        db.delete_column(u'main_userprofile', 'account')
    ...
    models = {
        ...
        u'main.userprofile': {
            ...
            'account': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
