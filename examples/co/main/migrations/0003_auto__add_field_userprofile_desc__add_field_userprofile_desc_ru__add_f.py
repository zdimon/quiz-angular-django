...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.desc'
        db.add_column(u'main_userprofile', 'desc',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.desc_ru'
        db.add_column(u'main_userprofile', 'desc_ru',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.desc_en'
        db.add_column(u'main_userprofile', 'desc_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.desc'
        db.delete_column(u'main_userprofile', 'desc')

        # Deleting field 'UserProfile.desc_ru'
        db.delete_column(u'main_userprofile', 'desc_ru')

        # Deleting field 'UserProfile.desc_en'
        db.delete_column(u'main_userprofile', 'desc_en')
