...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vcourse'
        db.create_table(u'videolearn_vcourse', (
            ...
            ('name_slug', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal(u'videolearn', ['Vcourse'])

        # Adding model 'Vlesson'
        db.create_table(u'videolearn_vlesson', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videolearn.Vcourse'], null=True, blank=True)),
            ('name_slug', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal(u'videolearn', ['Vlesson'])

        # Adding model 'Varticles'
        db.create_table(u'videolearn_varticles', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('lesson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videolearn.Vlesson'], null=True, blank=True)),
        ))
        db.send_create_signal(u'videolearn', ['Varticles'])


    def backwards(self, orm):
        # Deleting model 'Vcourse'
        db.delete_table(u'videolearn_vcourse')

        # Deleting model 'Vlesson'
        db.delete_table(u'videolearn_vlesson')

        # Deleting model 'Varticles'
        db.delete_table(u'videolearn_varticles')
