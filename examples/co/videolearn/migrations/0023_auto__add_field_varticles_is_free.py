...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Varticles.is_free'
        db.add_column(u'videolearn_varticles', 'is_free',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Varticles.is_free'
        db.delete_column(u'videolearn_varticles', 'is_free')
