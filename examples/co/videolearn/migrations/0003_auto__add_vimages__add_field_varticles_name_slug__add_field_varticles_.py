...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vimages'
        db.create_table(u'videolearn_vimages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('cropping', self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videolearn.Varticles'])),
        ))
        db.send_create_signal(u'videolearn', ['Vimages'])

        # Adding field 'Varticles.name_slug'
        db.add_column(u'videolearn_varticles', 'name_slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Varticles.pub'
        db.add_column(u'videolearn_varticles', 'pub',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Vimages'
        db.delete_table(u'videolearn_vimages')

        # Deleting field 'Varticles.name_slug'
        db.delete_column(u'videolearn_varticles', 'name_slug')

        # Deleting field 'Varticles.pub'
        db.delete_column(u'videolearn_varticles', 'pub')
