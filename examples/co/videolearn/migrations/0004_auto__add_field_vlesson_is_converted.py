...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vlesson.is_converted'
        db.add_column(u'videolearn_vlesson', 'is_converted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vlesson.is_converted'
        db.delete_column(u'videolearn_vlesson', 'is_converted')
