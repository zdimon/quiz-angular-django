...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Varticles.desc'
        db.alter_column(u'videolearn_varticles', 'desc', self.gf('redactor.fields.RedactorField')())
        # Adding field 'Vcourse.adesc'
        db.add_column(u'videolearn_vcourse', 'adesc',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Varticles.desc'
        db.alter_column(u'videolearn_varticles', 'desc', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Vcourse.adesc'
        db.delete_column(u'videolearn_vcourse', 'adesc')
    ...
    models = {
        ...
        u'videolearn.vcourse': {
            ...
            'adesc': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
