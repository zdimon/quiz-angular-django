...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Access'
        db.create_table(u'videolearn_access', (
            ...
            ('alias', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal(u'videolearn', ['Access'])


    def backwards(self, orm):
        # Deleting model 'Access'
        db.delete_table(u'videolearn_access')
