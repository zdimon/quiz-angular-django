...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vlesson.type'
        db.delete_column(u'videolearn_vlesson', 'type')

        # Adding field 'Vcourse.type'
        db.add_column(u'videolearn_vcourse', 'type',
                      self.gf('django.db.models.fields.CharField')(default='v', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Vlesson.type'
        db.add_column(u'videolearn_vlesson', 'type',
                      self.gf('django.db.models.fields.CharField')(default='v', max_length=2),
                      keep_default=False)

        # Deleting field 'Vcourse.type'
        db.delete_column(u'videolearn_vcourse', 'type')
    ...
    models = {
        ...
        u'videolearn.varticles': {
            ...
            'adesc': ('redactor.fields.RedactorField', [], {'blank': 'True'}),
            'desc': ('redactor.fields.RedactorField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lesson': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['videolearn.Vlesson']", 'null': 'True', 'blank': 'True'}),
        ...
        u'videolearn.vcourse': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'v'", 'max_length': '2'})
        },
