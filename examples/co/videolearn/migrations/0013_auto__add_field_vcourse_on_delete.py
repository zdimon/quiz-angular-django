...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vcourse.on_delete'
        db.add_column(u'videolearn_vcourse', 'on_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vcourse.on_delete'
        db.delete_column(u'videolearn_vcourse', 'on_delete')
