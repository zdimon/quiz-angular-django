...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vlesson.is_public'
        db.add_column(u'videolearn_vlesson', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vlesson.is_public'
        db.delete_column(u'videolearn_vlesson', 'is_public')
