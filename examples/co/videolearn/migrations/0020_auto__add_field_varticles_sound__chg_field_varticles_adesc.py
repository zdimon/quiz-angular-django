...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Varticles.sound'
        db.add_column(u'videolearn_varticles', 'sound',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Varticles.adesc'
        db.alter_column(u'videolearn_varticles', 'adesc', self.gf('redactor.fields.RedactorField')())

    def backwards(self, orm):
        # Deleting field 'Varticles.sound'
        db.delete_column(u'videolearn_varticles', 'sound')


        # Changing field 'Varticles.adesc'
        db.alter_column(u'videolearn_varticles', 'adesc', self.gf('django.db.models.fields.TextField')())
