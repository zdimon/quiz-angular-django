...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vsounds'
        db.create_table(u'videolearn_vsounds', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sound', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videolearn.Varticles'])),
            ('pub', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'videolearn', ['Vsounds'])


    def backwards(self, orm):
        # Deleting model 'Vsounds'
        db.delete_table(u'videolearn_vsounds')
