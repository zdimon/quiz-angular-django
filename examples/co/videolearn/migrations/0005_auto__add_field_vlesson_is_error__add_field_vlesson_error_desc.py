...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vlesson.is_error'
        db.add_column(u'videolearn_vlesson', 'is_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Vlesson.error_desc'
        db.add_column(u'videolearn_vlesson', 'error_desc',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vlesson.is_error'
        db.delete_column(u'videolearn_vlesson', 'is_error')

        # Deleting field 'Vlesson.error_desc'
        db.delete_column(u'videolearn_vlesson', 'error_desc')
