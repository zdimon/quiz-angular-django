...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vlesson.video'
        db.add_column(u'videolearn_vlesson', 'video',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Vcourse.video'
        db.delete_column(u'videolearn_vcourse', 'video')


    def backwards(self, orm):
        # Deleting field 'Vlesson.video'
        db.delete_column(u'videolearn_vlesson', 'video')

        # Adding field 'Vcourse.video'
        db.add_column(u'videolearn_vcourse', 'video',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
