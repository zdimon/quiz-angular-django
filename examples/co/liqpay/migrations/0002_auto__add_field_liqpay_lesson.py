...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Liqpay.lesson'
        db.add_column(u'liqpay_liqpay', 'lesson',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videolearn.Vlesson'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Liqpay.lesson'
        db.delete_column(u'liqpay_liqpay', 'lesson_id')
