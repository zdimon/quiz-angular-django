...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'course_course', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.cropping'
        db.add_column(u'course_course', 'cropping',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'course_course', 'image')

        # Deleting field 'Course.cropping'
        db.delete_column(u'course_course', 'cropping')
