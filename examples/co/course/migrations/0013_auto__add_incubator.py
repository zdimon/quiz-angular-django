...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Incubator'
        db.create_table(u'course_incubator', (
        ...
        db.send_create_signal(u'course', ['Incubator'])


    def backwards(self, orm):
        # Deleting model 'Incubator'
        db.delete_table(u'course_incubator')
