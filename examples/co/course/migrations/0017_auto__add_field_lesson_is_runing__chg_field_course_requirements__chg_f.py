...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.is_runing'
        db.add_column(u'course_lesson', 'is_runing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Course.requirements'
        db.alter_column(u'course_course', 'requirements', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Course.desc'
        db.alter_column(u'course_course', 'desc', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Lesson.is_runing'
        db.delete_column(u'course_lesson', 'is_runing')


        # Changing field 'Course.requirements'
        db.alter_column(u'course_course', 'requirements', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Course.desc'
        db.alter_column(u'course_course', 'desc', self.gf('ckeditor.fields.RichTextField')())
    ...
    models = {
        ...
        u'course.lesson': {
            ...
            'is_runing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
