...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'course_lesson', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lesson.cropping'
        db.add_column(u'course_lesson', 'cropping',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'course_lesson', 'image')

        # Deleting field 'Lesson.cropping'
        db.delete_column(u'course_lesson', 'cropping')
    ...
    models = {
        ...
        u'course.lesson': {
            ...
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'subscribers'", 'symmetrical': 'False', 'to': u"orm['main.UserProfile']"})
        },
        u'course.topic': {
