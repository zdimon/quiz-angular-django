...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Users2Course'
        db.create_table(u'course_users2course', (
        ...
        db.send_create_signal(u'course', ['Users2Course'])


    def backwards(self, orm):
        # Deleting model 'Users2Course'
        db.delete_table(u'course_users2course')
