...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Images.publish'
        db.alter_column(u'course_images', 'publish', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'Images.publish'
        db.alter_column(u'course_images', 'publish', self.gf('django.db.models.fields.BooleanField')())
